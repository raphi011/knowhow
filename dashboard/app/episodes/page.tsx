...
export default function Episodes() {
  ...
  useEffect(() => {
    ...
    graphql<{ episodes: Episode[] }>(QUERIES.episodes, { context, limit: 50 })
      .then(res => {
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="space-y-6">
            {loading ? (
              ...
              <Link href={`/episode/${encodeURIComponent(episode.id)}`} key={episode.id} className="bg-surface-dark rounded-2xl border border-[#233f48] overflow-hidden group hover:border-primary/40 transition-all shadow-xl block">
                <div className="px-6 py-4 border-b border-[#233f48] bg-black/10 flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="text-[10px] font-black text-text-secondary uppercase tracking-widest">{episode.timestamp ? new Date(episode.timestamp).toLocaleString() : ''}</span>
                ...
                <div className="p-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2 items-center">
                    ...
                    <div className="ml-auto text-[10px] font-bold text-text-secondary flex items-center gap-2">
                      ...
                      {episode.accessCount || 0} Accesses
                    </div>
                  </div>
                </div>
              </Link>
