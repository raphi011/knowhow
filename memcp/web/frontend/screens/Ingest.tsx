...
// Corrected import: useToast was not exported from App, useApp is the correct hook for application context.
import { useApp } from '../App';

const Ingest = () => {
  // Corrected usage: useApp provides the showToast function through the application context.
