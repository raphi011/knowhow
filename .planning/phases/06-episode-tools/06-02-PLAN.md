...
8. Build response with truncated content (500 chars):
...
Check: NewSearchEpisodesHandler exists and exported
  ...
  <done>
search_episodes handler added with time filtering and context detection
  </done>
</task>
...
3. Manual verification: Start server, use MCP inspector to:
   ...
   - Call search_episodes with query "test" - returns matching episodes
