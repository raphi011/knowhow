...
Plans:
- [x] 04-01-PLAN.md — remember tool (entity upsert with embeddings)
- [x] 04-02-PLAN.md — remember tool (relations), forget tool
...
Plans:
- [x] 06-01-PLAN.md — add_episode, get_episode, delete_episode tools
- [x] 06-02-PLAN.md — search_episodes tool with time filtering
